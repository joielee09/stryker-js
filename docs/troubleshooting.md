...
### Error when running StrykerJS: `Cannot use the decorators and decorators-legacy plugin together`
**Example**:

When running Stryker, you may get an error similar to the following one:
```
